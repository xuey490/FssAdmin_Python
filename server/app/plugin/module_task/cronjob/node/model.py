...
class NodeModel(ModelMixin, TenantMixin):
    """节点类型模型 - 动态定义节点类型"""
    ...
    uuid: Mapped[str] = mapped_column(
        String(64), nullable=False, default=lambda: str(uuid.uuid4()), comment="UUID全局唯一标识"
    )
    ...
    created_by: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="创建人ID")
    updated_by: Mapped[int | None] = mapped_column(Integer, nullable=True, comment="更新人ID")
